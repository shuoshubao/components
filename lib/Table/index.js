...
import { arrayMove, classNames, isEmptyArray, isEveryFalsy, isSomeTruthy, setAsyncState } from '@nbfe/tools'
import { Table, Typography, message } from 'antd'
import { cloneDeep, debounce, find, get, identity, isEqual, isFunction, isNull, map, omit, pick } from 'lodash'
...
class Index extends React.Component {
  ...
  render() {
    ...
    const tableProps = omit(props, ['class', 'className', 'style', 'columns', 'dataSource', 'remoteConfig', 'pagination', 'renderItem'])
    ...
    Object.assign(listProps, pick(tableProps, ['dataSource', 'renderItem', 'pagination', 'loading', 'rowKey', 'size', 'loadMore']))
