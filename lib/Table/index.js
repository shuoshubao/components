...
import { cloneDeep, get, omit, isEqual, isFunction, debounce, map, find, isNull, pick } from 'lodash'
...
class Index extends Component {
  ...
  render() {
    ...
    Object.assign(listProps, pick(tableProps, 'rowKey', 'size', 'loading'))

    if (pagination) {
      listProps.pagination = pick(tableProps.pagination, 'current', 'pageSize', 'total')
    } else {
