...
export const RotateLeftOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const RotateRightOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const ZoomOutOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const CaretDownOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const CaretUpOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const FullscreenOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
...
export const FullscreenExitOutlined = props => {
  const svgProps = getSvgProps(props)
  return (
    <span className={classNames('anticon', props.className)}>
      <svg {...svgProps}>
