...
import { classNames, formatTime, isEmptyArray, isEmptyValue, isEveryFalsy } from '@nbfe/tools'
import { Button, Checkbox, Radio, Tooltip, TreeSelect } from 'antd'
import { cloneDeep, filter, flatten, get, isEqual, isFunction, isObject, isUndefined, merge, set } from 'lodash'
...
export const defaultExtraConfig = {
  ...
  defaultViewMode: 'table', // 'table' / 'list'
  listViewText: '列表' // '列表' / '卡片' / '网格'
}
...
export const getInitialViewMode = props => {
  const { storageKey, showViewMode, defaultViewMode } = {
    ...defaultExtraConfig,
    ...props.extraConfig
  }
  if (!showViewMode) {
