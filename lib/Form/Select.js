...
import { cloneDeep, debounce, find, isEqual, isObject, map, noop, omit, pick } from 'lodash'
...
class Index extends React.Component {
  ...
  render() {
    ...
    const componentProps = omit(props, ['initialValue', 'value', 'onChange', 'onCustomChange', 'options', 'allItem', 'remoteConfig'])
    if (showSearch) {
