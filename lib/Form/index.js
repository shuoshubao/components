...
class Index extends Component {
  ...
  renderColumns = () => {
    ...
    const columnsNode = columns
      ...
      .map((v, i) => {
        const { name, label, tooltip, colon, formListConfig, template } = v
  ...
  renderSearchReset = () => {
    ...
    const { submitText, resetText } = {
      ...defaultExtraConfig,
      ...extraConfig
    }

    return (
      <Form.Item colon={false} className={getClassNames('form-item')}>
        <Space>
          {showSearch && (
