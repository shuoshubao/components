...
class Index extends Component {
  ...
  renderSearchReset = () => {
    ...
    const { columns } = state
    const { showSubmit, showReset, extraConfig } = props
  ...
  render() {
    ...
    const formProps = omit(props, ['columns', 'autoSubmit', 'showSubmit', 'showReset', 'labelWidth', 'visibleFilterPanel', 'extraConfig'])
