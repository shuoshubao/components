...
class Index extends Component {
  ...
  render() {
    ...
    const componentProps = omit(props, ['initialValue', 'value', 'onChange', 'onCustomChange', 'style', 'InputNumberWidth'])
    return (
      <div
        style={{
          display: 'flex',
      ...
      >
        <Slider style={{ width: style.width - InputNumberWidth - 15 }} value={value} onChange={onChange} onAfterChange={onAfterChange} {...componentProps} />
