...
import { cloneDeep, find, isObject, last, noop, omit } from 'lodash'
...
class Index extends React.Component {
  ...
  render() {
    ...
    const { options } = state
    const componentProps = omit(props, ['initialValue', 'value', 'onChange', 'onCustomChange', 'options', 'remoteConfig', 'loadData'])
    if (loadData) {
