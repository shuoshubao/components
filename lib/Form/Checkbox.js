...
import { cloneDeep, find, isObject, map, noop, omit, pick } from 'lodash'
...
class Index extends React.Component {
  ...
  render() {
    ...
    const componentProps = omit(props, ['initialValue', 'value', 'onChange', 'options', 'onCustomChange', 'remoteConfig', 'indeterminate', 'defaultSelectAll'])
    return (
      <>
